...
resource "azurerm_logic_app_standard" "send_to_splunk" {
  ...
  app_settings = {
    ...
    "EventQueueConnectionId"                  = "${azurerm_logic_app_standard.send_to_splunk.id}/connections/EventQueueConnector"
    ...
    "BatchWorkflowId"                         = "${azurerm_logic_app_standard.send_to_splunk.id}/workflows/BatchToSplunk"
  }
